...
void insert_slist(slist_t* slist, void* elem) {
	struct list_head* link = ((struct list_head*) (((char*) elem)
			+ slist->node_offset));
...
void insert_after_slist(slist_t *slist, void *object, void *nobject) {
	struct list_head* prev_node = ((struct list_head*) (((char*) object)
			+ slist->node_offset));
	struct list_head* new_node = ((struct list_head*) (((char*) nobject)
			+ slist->node_offset));
