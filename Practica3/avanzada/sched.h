...
extern sched_class_t mlq_sched;

/* Numerical IDs for the available scheduling algorithms */
enum {
	RR_SCHED, SJF_SCHED, FCFS_SCHED, PRIO_SCHED, MLQ_SCHED, NR_AVAILABLE_SCHEDULERS
};
...
static const sched_choice_t available_schedulers[NR_AVAILABLE_SCHEDULERS] =
		{ { RR_SCHED, "RR", &rr_sched }, { SJF_SCHED, "SJF", &sjf_sched }, {
				FCFS_SCHED, "FCFS", &fcfs_sched }, { PRIO_SCHED, "PRIO",
				&prio_sched }, {MLQ_SCHED, "MLQ", &mlq_sched}, };
